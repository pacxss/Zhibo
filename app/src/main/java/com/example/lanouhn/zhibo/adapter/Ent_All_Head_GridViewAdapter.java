...
/**
 * 娱乐页面中全部中头部的GridView的适配器
 * Created by lanouhn on 2016/8/19.
 */
public class Ent_All_Head_GridViewAdapter extends BaseAdapter{

    private Context context;
    private List<rooms> list;
    private int selectedPos;

    public Ent_All_Head_GridViewAdapter(Context context, List<rooms> list) {
