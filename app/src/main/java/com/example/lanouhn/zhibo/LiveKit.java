...
import com.example.lanouhn.zhibo.view.BaseMsgView;
import com.example.lanouhn.zhibo.message.GiftMessage;
import com.example.lanouhn.zhibo.view.GiftMsgView;
import com.example.lanouhn.zhibo.view.InfoMsgView;
import com.example.lanouhn.zhibo.view.TextMsgView;
...
public class LiveKit {
     ...
     * 事件代码
     */
    public static final int MESSAGE_ARRIVED = 4;
