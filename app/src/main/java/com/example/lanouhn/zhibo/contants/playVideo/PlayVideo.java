package com.example.lanouhn.zhibo.contants.playVideo;
...
public class PlayVideo {
    ...
    public List<com.example.lanouhn.zhibo.contants.playVideo.playLines> getPlayLines() {
        return playLines;
    }

    public void setPlayLines(List<com.example.lanouhn.zhibo.contants.playVideo.playLines> playLines) {
